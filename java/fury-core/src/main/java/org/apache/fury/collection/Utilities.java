...
public final class Utilities {
     ...
     * {@link ObjectMap#regenHashMultipliers(int)} method (on any hashed data structure here) is used
    ...
    /**
     * Used to establish the size of a hash table for {@link ObjectMap} and related code.
